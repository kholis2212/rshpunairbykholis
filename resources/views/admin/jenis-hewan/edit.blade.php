{{-- views/admin/jenis-hewan/edit.blade.php --}}
        ...
        <div class="col-lg-8 col-md-10">
            ...
            <div class="warning-card mb-4">
                ...
                <div class="warning-card-content">
                    <h6>Perhatian!</h6>
                    <p>Pastikan nama jenis hewan yang baru tidak duplikat dengan data yang sudah ada untuk menghindari konflik data dalam sistem</p>
                </div>
            </div>
            ...
            <div class="card form-card">
                <div class="card-header">
                    ...
                    <div class="card-header-text">
                        <h5>Form Edit Jenis Hewan</h5>
                        <p>Perbarui data jenis hewan dengan informasi yang benar</p>
                    </div>
                </div>

                <div class="card-body">
                    <form action="{{ route('admin.jenis-hewan.update', $jenisHewan->idjenis_hewan) }}" method="POST" id="formEdit">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-hint">
                                ...
                                <span>Ubah nama jenis hewan sesuai dengan kebutuhan sistem</span>
                            </div>
                        </div>
                        ...
                        <div class="comparison-section">
                            ...
                            <div class="comparison-grid">
                                <div class="comparison-item comparison-old">
                                    ...
                                    <div class="comparison-value">{{ $jenisHewan->nama_jenis_hewan }}</div>
                                </div>
                                ...
                                <div class="comparison-item comparison-new">
                                    ...
                                    <div class="comparison-value" id="newValuePreview">
                                        {{ old('nama_jenis_hewan', $jenisHewan->nama_jenis_hewan) }}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-actions">
                            ...
                            <a href="{{ route('admin.jenis-hewan.index') }}" class="btn btn-secondary btn-cancel">
...
@section('extra-js')
    <script>
        ...
        input.addEventListener('input', function() {
            const newValue = this.value.trim() || '{{ $jenisHewan->nama_jenis_hewan }}';
        ...
        document.getElementById('formEdit').addEventListener('submit', function(e) {
            if (input.value.trim() === '') {
                ...
                if (!document.querySelector('.invalid-feedback')) {
                    ...
                    errorDiv.innerHTML = '<i class="bi bi-exclamation-circle-fill"></i><span>Nama jenis hewan wajib diisi!</span>';
