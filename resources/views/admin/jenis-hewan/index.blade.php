{{-- views/admin/jenis-hewan/index.blade.php --}}
...
@section('content')
    ...
    <div class="info-banner mb-4">
        ...
        <div class="info-banner-content">
            <h6>Tentang Data Jenis Hewan</h6>
            <p>Kelola kategori jenis hewan seperti anjing, kucing, burung, kelinci dan lainnya untuk sistem RSHP UNAIR</p>
        </div>
    </div>
        ...
        <div class="card-header">
            <div class="card-header-left">
                ...
                <div class="header-text">
                    <h5>Daftar Jenis Hewan</h5>
                    <p>Total: <span class="badge badge-count">{{ $jenisHewan->count() }}</span> jenis hewan terdaftar</p>
                </div>
            </div>
        </div>
        ...
        <div class="card-body p-0">
            @if($jenisHewan->count() > 0)
                ...
                <div class="table-controls">
                    <div class="controls-left">
                        ...
                        <div class="search-box">
                            ...
                            <input type="text" id="searchInput" placeholder="Cari jenis hewan...">
                        </div>
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="table-main-info">
                                        <span>{{ $item->nama_jenis_hewan }}</span>
                                    </div>
                                </td>
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        <button data-id="{{ $item->idjenis_hewan }}" 
                                                data-name="{{ $item->nama_jenis_hewan }}"
                ...
                <div class="table-footer">
                    <div class="showing-entries">
                        ...
                        <span id="showingText">Menampilkan 1 hingga {{ min(10, $jenisHewan->count()) }} dari {{ $jenisHewan->count() }} data</span>
                    </div>
            ...
            @else
                <div class="empty-state">
                    ...
                    <p>Silakan tambahkan data jenis hewan terlebih dahulu untuk memulai</p>
                    <a href="{{ route('admin.jenis-hewan.create') }}" class="btn-empty">
                        <i class="bi bi-plus-circle-fill"></i>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <p class="modal-text">Apakah Anda yakin ingin menghapus jenis hewan <strong id="deleteItemName"></strong>?</p>
    ...
    <script>
        ...
        function searchTable() {
            ...
            filteredRows = allRows.filter(row => {
                const td = row.getElementsByTagName('td')[1]; // Kolom nama jenis hewan
                if (td) {
