{{-- views/admin/jenis-hewan/create.blade.php --}}
        ...
        <div class="col-lg-8 col-md-10">
            ...
            <div class="info-card mb-4">
                ...
                <div class="info-card-content">
                    <h6>Informasi</h6>
                    <p>Pastikan nama jenis hewan yang Anda masukkan belum terdaftar dalam sistem untuk menghindari duplikasi data</p>
                </div>
            </div>
            ...
            <div class="card form-card">
                <div class="card-header">
                    ...
                    <div class="card-header-text">
                        <h5>Form Tambah Jenis Hewan</h5>
                        <p>Isi formulir di bawah dengan lengkap dan benar</p>
                    </div>
                </div>

                <div class="card-body">
                    <form action="{{ route('admin.jenis-hewan.store') }}" method="POST" id="formCreate">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <input type="text" 
                                       ...
                                       placeholder="Contoh: Kucing, Anjing, Burung, Kelinci"
                                       autofocus>
                            ...
                            <div class="form-hint">
                                ...
                                <span>Masukkan nama jenis hewan yang spesifik dan mudah dikenali</span>
                            </div>
                        </div>
