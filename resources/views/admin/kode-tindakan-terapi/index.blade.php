...
<head>
    ...
    <title>Data Kode Tindakan Terapi - RSHP UNAIR</title>
...
<body>
        ...
        <div class="header-card">
            <div class="header-title">
                ...
                <div>
                    ...
                    <p>Kelola kode tindakan dan terapi medis untuk hewan</p>
                </div>
            </div>
            <div class="header-actions">
                ...
                <a href="{{ route('admin.kode-tindakan-terapi.create') }}" class="btn btn-success">
                    <span>➕</span>
        ...
        <div class="table-card">
            <div class="table-header">
                ...
                <div class="search-box">
                    <input type="text" id="searchInput" placeholder="🔍 Cari kode/deskripsi..." onkeyup="searchTable()">
                </div>
            </div>
            ...
            <div class="table-wrapper">
                    ...
                    <table id="dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge badge-code">{{ $item->kode }}</span>
                                </td>
                                <td style="font-weight: 500;">{{ $item->deskripsi_tindakan_terapi }}</td>
                                <td>
                                    <span class="badge badge-kategori">{{ $item->kategori->nama_kategori }}</span>
                                </td>
                                <td>
                                    <span class="badge badge-klinis">{{ $item->kategoriKlinis->nama_kategori_klinis }}</span>
                                </td>
                                <td>
                                    <div class="action-buttons" style="justify-content: center;">
                                        ...
                                        <button onclick="confirmDelete({{ $item->idkode_tindakan_terapi }}, '{{ $item->kode }}')" class="btn btn-danger btn-sm">
                                            <span>🗑️</span>
                                            <span>Hapus</span>
                                        </button>
                                    </div>
                ...
                @else
                    <div class="empty-state">
                        ...
                        <p>Silakan tambahkan data kode tindakan terapi terlebih dahulu</p>
                        <a href="{{ route('admin.kode-tindakan-terapi.create') }}" class="btn btn-success" style="margin-top: 20px;">
                            <span>➕</span>
    ...
    <div id="deleteModal" class="modal">
        <div class="modal-content">
            ...
            <p>Apakah Anda yakin ingin menghapus kode <strong id="deleteItemName"></strong>?</p>
    ...
    <script>
        ...
        function searchTable() {
            ...
            for (let i = 1; i < tr.length; i++) {
                ...
                // Search dalam kolom kode, deskripsi, kategori, kategori klinis
                for (let j = 1; j <= 4; j++) {
                    if (tds[j]) {
