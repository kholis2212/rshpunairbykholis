{{-- views/admin/kode-tindakan-terapi/index.blade.php --}}
@extends('layouts.lte.main')

@section('title', 'Data Kode Tindakan Terapi - RSHP UNAIR')

@section('page-icon', 'activity')
...
@section('content')
    ...
    <div class="info-banner mb-4">
        ...
        <div class="info-banner-content">
            <h6>Tentang Data Kode Tindakan Terapi</h6>
            <p>Kelola kode tindakan dan terapi medis untuk hewan dalam sistem RSHP UNAIR. Setiap kode mewakili prosedur medis tertentu dengan kategori dan klasifikasi klinis yang sesuai.</p>
        </div>
    </div>
        ...
        <div class="card-header">
            <div class="card-header-left">
                ...
                <div class="header-text">
                    <h5>Daftar Kode Tindakan Terapi</h5>
                    <p>Total: <span class="badge badge-count">{{ $kodeTindakanTerapi->count() }}</span> kode terdaftar</p>
                </div>
            </div>
        </div>

        <div class="card-body p-0">
            @if($kodeTindakanTerapi->count() > 0)
                <!-- Table Controls -->
                <div class="table-controls">
                    <div class="controls-left">
                        ...
                        <div class="search-box">
                            ...
                            <input type="text" id="searchInput" placeholder="Cari kode/deskripsi/kategori...">
                        </div>
                    </div>
                    
                    <div class="controls-right">
                        <!-- Add Button -->
                        <a href="{{ route('admin.kode-tindakan-terapi.create') }}" class="btn-add">
                    ...
                    <table class="table data-table" id="dataTable">
                            ...
                            <tr>
                                ...
                                <th>
                                    <div class="th-content">
                                        ...
                                        <span>Deskripsi Tindakan/Terapi</span>
                                    </div>
                                </th>
                        ...
                        <tbody id="tableBody">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="table-main-info">
                                        <span class="text-description">{{ Str::limit($item->deskripsi_tindakan_terapi, 80) }}</span>
                                    </div>
                                </td>
                                <td>
                                    <div class="table-main-info">
                                ...
                                <td>
                                    <div class="table-main-info">
                                        <span class="badge-klinis">{{ $item->nama_kategori_klinis }}</span>
                                    </div>
                                </td>
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        <button data-id="{{ $item->idkode_tindakan_terapi }}" 
                                                data-name="{{ $item->kode }} - {{ Str::limit($item->deskripsi_tindakan_terapi, 30) }}"
                ...
                <div class="table-footer">
                    <div class="showing-entries">
                        ...
                        <span id="showingText">Menampilkan 1 hingga {{ min(10, $kodeTindakanTerapi->count()) }} dari {{ $kodeTindakanTerapi->count() }} data</span>
                    </div>
            ...
            @else
                <div class="empty-state">
                    ...
                    <p>Silakan tambahkan data kode tindakan terapi terlebih dahulu untuk memulai</p>
                    <a href="{{ route('admin.kode-tindakan-terapi.create') }}" class="btn-empty">
                        <i class="bi bi-plus-circle-fill"></i>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <p class="modal-text">Apakah Anda yakin ingin menghapus kode tindakan terapi <strong id="deleteItemName"></strong>?</p>
    ...
    <style>
        /* Badge Styles for Kode Tindakan Terapi */
        .badge-code {
        ...
        /* Include all existing styles from jenis-hewan index */
        :root {
            --primary: #0077b6;
            --primary-dark: #023e8a;
            --secondary: #0096c7;
    ...
    <script>
        ...
        function searchTable() {
            ...
            filteredRows = allRows.filter(row => {
                ...
                // Search in all columns except action column
                for (let i = 1; i <= 4; i++) {
                    if (tds[i]) {
                        const txtValue = tds[i].textContent || tds[i].innerText;
        ...
        function confirmDelete(id, name) {
            ...
            form.action = `/admin/kode-tindakan-terapi/${id}`;
