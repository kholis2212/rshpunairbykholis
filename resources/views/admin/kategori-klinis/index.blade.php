{{-- views/admin/kategori-klinis/index.blade.php --}}
@extends('layouts.lte.main')

@section('title', 'Data Kategori Klinis - RSHP UNAIR')

@section('page-icon', 'hospital-fill')
...
@section('content')
    ...
    <div class="info-banner mb-4">
        ...
        <div class="info-banner-content">
            <h6>Tentang Data Kategori Klinis</h6>
            <p>Kelola kategori klinis untuk kondisi medis hewan seperti terapi, tindakan, bedah, diagnostik, dan lainnya untuk sistem RSHP UNAIR</p>
        </div>
    </div>
        ...
        <div class="card-header">
            <div class="card-header-left">
                ...
                <div class="header-text">
                    <h5>Daftar Kategori Klinis</h5>
                    <p>Total: <span class="badge badge-count">{{ $kategoriKlinis->count() }}</span> kategori klinis terdaftar</p>
                </div>
            </div>
        </div>
        ...
        <div class="card-body p-0">
            @if($kategoriKlinis->count() > 0)
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="table-main-info">
                                        <span>{{ $item->nama_kategori_klinis }}</span>
                                    </div>
                                </td>
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        <button data-id="{{ $item->idkategori_klinis }}" 
                                                data-name="{{ $item->nama_kategori_klinis }}"
                ...
                <div class="table-footer">
                    <div class="showing-entries">
                        ...
                        <span id="showingText">Menampilkan 1 hingga {{ min(10, $kategoriKlinis->count()) }} dari {{ $kategoriKlinis->count() }} data</span>
                    </div>
            ...
            @else
                <div class="empty-state">
                    ...
                    <p>Silakan tambahkan data kategori klinis terlebih dahulu untuk memulai</p>
                    <a href="{{ route('admin.kategori-klinis.create') }}" class="btn-empty">
                        <i class="bi bi-plus-circle-fill"></i>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <p class="modal-text">Apakah Anda yakin ingin menghapus kategori klinis <strong id="deleteItemName"></strong>?</p>
    ...
    <script>
        ...
        function searchTable() {
            ...
            filteredRows = allRows.filter(row => {
                const td = row.getElementsByTagName('td')[1]; // Kolom nama kategori klinis
                if (td) {
                    const txtValue = td.textContent || td.innerText;
                    const isMatch = txtValue.toLowerCase().includes(filter);
                    console.log('Checking:', txtValue, '- Match:', isMatch);
                    return isMatch;
                }
                return false;
            });
        ...
        function confirmDelete(id, name) {
            ...
            form.action = `/admin/kategori-klinis/${id}`;
