...
<head>
    ...
    <title>Data Kategori Klinis - RSHP UNAIR</title>
...
<body>
        ...
        <div class="header-card">
            <div class="header-title">
                ...
                <div>
                    ...
                    <p>Kelola kategori klinis untuk kondisi medis hewan</p>
                </div>
            </div>
            <div class="header-actions">
                ...
                <a href="{{ route('admin.kategori-klinis.create') }}" class="btn btn-success">
                    <span>➕</span>
        ...
        <div class="table-card">
            <div class="table-header">
                ...
                <div class="search-box">
                    <input type="text" id="searchInput" placeholder="🔍 Cari kategori klinis..." onkeyup="searchTable()">
                </div>
            </div>
            ...
            <div class="table-wrapper">
                    ...
                    <table id="dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="font-weight: 500;">{{ $item->nama_kategori_klinis }}</td>
                                <td>
                                    <div class="action-buttons" style="justify-content: center;">
                                        ...
                                        <button onclick="confirmDelete({{ $item->idkategori_klinis }}, '{{ $item->nama_kategori_klinis }}')" class="btn btn-danger btn-sm">
                                            <span>🗑️</span>
                                            <span>Hapus</span>
                                        </button>
                                    </div>
                ...
                @else
                    <div class="empty-state">
                        ...
                        <p>Silakan tambahkan data kategori klinis terlebih dahulu</p>
                        <a href="{{ route('admin.kategori-klinis.create') }}" class="btn btn-success" style="margin-top: 20px;">
                            <span>➕</span>
    ...
    <div id="deleteModal" class="modal">
        <div class="modal-content">
            ...
            <p>Apakah Anda yakin ingin menghapus kategori klinis <strong id="deleteItemName"></strong>?</p>
