    ...
    <div class="container">
        <div class="form-card">
            ...
            <div class="form-header">
                ...
                <p>Isi formulir di bawah untuk menambah kategori klinis baru</p>
            </div>

            <!-- Body -->
            <div class="form-body">
                <div class="form-hint">
                    <span>Kategori klinis digunakan untuk mengelompokkan kondisi atau tindakan medis pada hewan. Pastikan nama yang Anda masukkan belum terdaftar dalam sistem.</span>
                </div>
