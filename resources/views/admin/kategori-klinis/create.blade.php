{{-- views/admin/kategori-klinis/create.blade.php --}}
        ...
        <div class="col-lg-8 col-md-10">
            ...
            <div class="info-card mb-4">
                ...
                <div class="info-card-content">
                    <h6>Informasi</h6>
                    <p>Pastikan nama kategori klinis yang Anda masukkan belum terdaftar dalam sistem untuk menghindari duplikasi data</p>
                </div>
            </div>
            ...
            <div class="card form-card">
                <div class="card-header">
                    ...
                    <div class="card-header-text">
                        <h5>Form Tambah Kategori Klinis</h5>
                        <p>Isi formulir di bawah dengan lengkap dan benar</p>
                    </div>
                </div>

                <div class="card-body">
                    <form action="{{ route('admin.kategori-klinis.store') }}" method="POST" id="formCreate">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                <input type="text" 
                                       ...
                                       placeholder="Contoh: Terapi, Tindakan, Bedah, Diagnostik, Rawat Inap"
                                       autofocus>
                            ...
                            <div class="form-hint">
                                ...
                                <span>Masukkan nama kategori klinis yang spesifik dan mudah dikenali</span>
                            </div>
                        </div>
