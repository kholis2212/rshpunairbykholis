{{-- views/admin/pemilik/index.blade.php --}}
...
@section('content')
    ...
    <div class="info-banner mb-4">
        ...
        <div class="info-banner-content">
            ...
            <p>Kelola data pemilik hewan untuk sistem RSHP UNAIR. Setiap pemilik memiliki akun user untuk login ke sistem</p>
        </div>
    </div>
        ...
        <div class="card-body p-0">
                ...
                <div class="table-controls">
                    <div class="controls-left">
                        ...
                        <div class="search-box">
                            ...
                            <input type="text" id="searchInput" placeholder="Cari nama, email, atau nomor WA...">
                        </div>
                    </div>
                    ...
                    <table class="table data-table" id="dataTable">
                        ...
                        <tbody id="tableBody">
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="text-whatsapp">{{ $item->no_wa }}</span>
                                </td>
                                <td>
                                    <span class="text-address">{{ $item->alamat }}</span>
                                </td>
                                <td>
            ...
            @else
                <div class="empty-state">
                    ...
                    <a href="{{ route('admin.pemilik.create') }}" class="btn-empty">
                        <i class="bi bi-person-plus-fill"></i>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Apakah Anda yakin ingin menghapus pemilik <strong id="deleteItemName"></strong>?</p>
                    <p class="text-danger"><small>Tindakan ini akan menghapus data pemilik dan akun user terkait!</small></p>
                </div>
    ...
    <script>
        ...
        function searchTable() {
            ...
            filteredRows = allRows.filter(row => {
                ...
                // Search in nama, email, no_wa, alamat
                for (let i = 1; i <= 4; i++) {
                    if (tds[i]) {
