...
<head>
    ...
    <title>Data Pemilik - RSHP UNAIR</title>
        ...
        <div class="header-card">
            <div class="header-title">
                ...
                <div>
                    ...
                    <p>Kelola data pemilik hewan untuk sistem RSHP</p>
                </div>
            </div>
        ...
        <div class="table-card">
            <div class="table-header">
                ...
                <div class="search-box">
                    <input type="text" id="searchInput" placeholder="🔍 Cari pemilik..." onkeyup="searchTable()">
                </div>
            </div>
            ...
            <div class="table-wrapper">
                    ...
                    <table id="dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="font-weight: 500;">{{ $item->user->nama }}</td>
                                ...
                                <td>
                                    <div class="action-buttons" style="justify-content: center;">
                                        ...
                                        <button onclick="confirmDelete({{ $item->idpemilik }}, '{{ $item->user->nama }}')" class="btn btn-danger btn-sm">
                                            <span>🗑️</span>
                                            <span>Hapus</span>
                                        </button>
                                    </div>
                ...
                @else
                    <div class="empty-state">
                        ...
                        <a href="{{ route('admin.pemilik.create') }}" class="btn btn-success" style="margin-top: 20px;">
                            <span>➕</span>
    ...
    <script>
        ...
        function searchTable() {
            ...
            for (let i = 1; i < tr.length; i++) {
                ...
                // Search dalam kolom nama, email, no_wa, alamat
                for (let j = 1; j <= 4; j++) {
                    if (tds[j]) {
