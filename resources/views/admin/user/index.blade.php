...
<head>
    ...
    <title>Data User - RSHP UNAIR</title>
...
<body>
    <div class="container">
        ...
        <div class="header-card">
            <div class="header-title">
                ...
                <div>
                    <h1>Data User</h1>
                    <p>Kelola data pengguna sistem RSHP</p>
                </div>
            </div>
            ...
            <div class="table-wrapper">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-buttons" style="justify-content: center;">
                                        ...
                                        <button onclick="confirmDelete({{ $user->iduser }}, '{{ $user->nama }}')" class="btn btn-danger btn-sm">
                                            <span>🗑️</span>
                                            <span>Hapus</span>
                                        </button>
                                    </div>
                ...
                @else
                    <div class="empty-state">
                        ...
                        <a href="{{ route('admin.user.create') }}" class="btn btn-success" style="margin-top: 20px;">
                            <span>➕</span>
    ...
    <div id="deleteModal" class="modal">
        <div class="modal-content">
            ...
            <p>Apakah Anda yakin ingin menghapus user <strong id="deleteItemName"></strong>?</p>
