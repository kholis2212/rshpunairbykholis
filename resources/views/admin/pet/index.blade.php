{{-- views/admin/pet/index.blade.php --}}
...
@section('content')
    ...
    <div class="info-banner mb-4">
        ...
        <div class="info-banner-content">
            <h6>Tentang Data Pet</h6>
            <p>Kelola data hewan peliharaan seperti nama, jenis kelamin, tanggal lahir, dan informasi pemilik untuk sistem RSHP UNAIR</p>
        </div>
    </div>
        ...
        <div class="card-header">
            <div class="card-header-left">
                ...
                <div class="header-text">
                    <h5>Daftar Pet</h5>
                    <p>Total: <span class="badge badge-count">{{ $pet->count() }}</span> pet terdaftar</p>
                </div>
            </div>
        </div>
        ...
        <div class="card-body p-0">
            @if($pet->count() > 0)
                ...
                <div class="table-controls">
                    <div class="controls-left">
                        ...
                        <div class="search-box">
                            ...
                            <input type="text" id="searchInput" placeholder="Cari pet...">
                        </div>
                    </div>
                    ...
                    <table class="table data-table" id="dataTable">
                        ...
                        <tbody id="tableBody">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="table-main-info">
                                        <span>{{ \Carbon\Carbon::parse($item->tanggal_lahir)->format('d/m/Y') }}</span>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="table-main-info">
                                        <span>{{ $item->warna_tanda }}</span>
                                    </div>
                                </td>
                                <td>
                                    <div class="table-main-info">
                                        <span>{{ $item->nama_ras }}</span>
                                        <small class="text-muted">({{ $item->nama_jenis_hewan }})</small>
                                    </div>
                                </td>
                                <td>
                                    <div class="table-main-info">
                                        <span>{{ $item->nama_pemilik }}</span>
                                    </div>
                                </td>
                                <td>
                ...
                <div class="table-footer">
                    <div class="showing-entries">
                        ...
                        <span id="showingText">Menampilkan 1 hingga {{ min(10, $pet->count()) }} dari {{ $pet->count() }} data</span>
                    </div>
            ...
            @else
                <div class="empty-state">
                    ...
                    <p>Silakan tambahkan data pet terlebih dahulu untuk memulai</p>
                    <a href="{{ route('admin.pet.create') }}" class="btn-empty">
                        <i class="bi bi-plus-circle-fill"></i>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <p class="modal-text">Apakah Anda yakin ingin menghapus pet <strong id="deleteItemName"></strong>?</p>
    ...
    <style>
        ...
        /* Badge Gender Styles */
        .badge-gender-male, .badge-gender-female {
            padding: 6px 12px;
            border-radius: 20px;
            font-size: 0.85rem;
            font-weight: 600;
        ...
        .badge-gender-female {
            background: linear-gradient(135deg, #f72585, #ef476f);
            color: white;
        }
    ...
    <script>
        ...
        function searchTable() {
            ...
            filteredRows = allRows.filter(row => {
                ...
                // Search in multiple columns (nama, warna, ras, pemilik)
                for (let i = 1; i <= 6; i++) {
                    if (tds[i]) {
