...
<head>
    ...
    <title>Data Pet - RSHP UNAIR</title>
...
<body>
    <div class="container">
        ...
        <div class="header-card">
            <div class="header-title">
                ...
                <div>
                    <h1>Data Pet</h1>
                    <p>Kelola data pet untuk sistem RSHP</p>
                </div>
            </div>
        ...
        <div class="table-card">
            <div class="table-header">
                ...
                <div class="search-box">
                    <input type="text" id="searchInput" placeholder="🔍 Cari pet..." onkeyup="searchTable()">
                </div>
            </div>
            ...
            <div class="table-wrapper">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($item->jenis_kelamin == 'L')
                                        <span class="badge badge-gender-male">♂ Jantan</span>
                                    @else
                                        <span class="badge badge-gender-female">♀ Betina</span>
                                    @endif
                                </td>
                                <td>{{ $item->warna_tanda }}</td>
                                <td>
                                    <span class="badge badge-info">{{ $item->rasHewan->nama_ras }}</span>
                                </td>
                                <td style="font-weight: 500;">{{ $item->pemilik->user->nama }}</td>
                                <td>
                                    <div class="action-buttons" style="justify-content: center;">
                                        ...
                                        <button onclick="confirmDelete({{ $item->idpet }}, '{{ $item->nama }}')" class="btn btn-danger btn-sm">
                                            <span>🗑️</span>
                                            <span>Hapus</span>
                                        </button>
                                    </div>
                ...
                @else
                    <div class="empty-state">
                        ...
                        <a href="{{ route('admin.pet.create') }}" class="btn btn-success" style="margin-top: 20px;">
                            <span>➕</span>
    ...
    <div id="deleteModal" class="modal">
        <div class="modal-content">
            ...
            <p>Apakah Anda yakin ingin menghapus pet <strong id="deleteItemName"></strong>?</p>
    ...
    <script>
        ...
        function searchTable() {
            ...
            for (let i = 1; i < tr.length; i++) {
                ...
                // Search dalam kolom nama, warna, ras, pemilik
                for (let j = 1; j <= 6; j++) {
                    if (tds[j]) {
