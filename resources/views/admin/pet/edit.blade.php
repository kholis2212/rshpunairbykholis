...
<head>
    ...
    <title>Edit Pet - RSHP UNAIR</title>
    ...
    <div class="container">
        <div class="form-card">
            ...
            <div class="form-header">
                ...
                <h1>Edit Pet</h1>
                <p>Perbarui data pet yang sudah ada</p>
            </div>

            <!-- Body -->
            <div class="form-body">
                <div class="current-value">
                    <div class="current-value-label">📝 Data Pet Saat Ini:</div>
                    <div class="current-value-text">{{ $pet->nama }} - {{ $pet->rasHewan->nama_ras }} ({{ $pet->pemilik->user->nama }})</div>
                </div>

                <div class="form-hint">
                    <span>Pastikan data yang diperbarui sesuai dengan informasi terbaru dari pemilik</span>
                </div>
