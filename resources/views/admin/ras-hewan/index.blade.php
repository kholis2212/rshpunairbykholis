{{-- views/admin/ras-hewan/index.blade.php --}}
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">Data Ras Hewan</li>
@endsection
...
@section('content')
    ...
    <div class="info-banner mb-4">
        ...
        <div class="info-banner-content">
            <h6>Tentang Data Ras Hewan</h6>
            <p>Kelola kategori ras hewan seperti Golden Retriever, Persia, Anggora, dan lainnya untuk sistem RSHP UNAIR</p>
        </div>
    </div>
        ...
        <div class="card-header">
            <div class="card-header-left">
                ...
                <div class="header-text">
                    <h5>Daftar Ras Hewan</h5>
                    <p>Total: <span class="badge badge-count">{{ $rasHewan->count() }}</span> ras hewan terdaftar</p>
                </div>
            </div>
        </div>
        ...
        <div class="card-body p-0">
            @if($rasHewan->count() > 0)
                ...
                <div class="table-controls">
                    ...
                    <div class="controls-right">
                        <!-- Add Button -->
                        <a href="{{ route('admin.ras-hewan.create') }}" class="btn-add">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="table-main-info">
                                        <span>{{ $item->nama_ras }}</span>
                                    </div>
                                </td>
                                <td>
                                    <span class="badge badge-category">{{ $item->nama_jenis_hewan }}</span>
                                </td>
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        <button data-id="{{ $item->idras_hewan }}" 
                                                data-name="{{ $item->nama_ras }}"
                ...
                <div class="table-footer">
                    <div class="showing-entries">
                        ...
                        <span id="showingText">Menampilkan 1 hingga {{ min(10, $rasHewan->count()) }} dari {{ $rasHewan->count() }} data</span>
                    </div>
            ...
            @else
                <div class="empty-state">
                    ...
                    <p>Silakan tambahkan data ras hewan terlebih dahulu untuk memulai</p>
                    <a href="{{ route('admin.ras-hewan.create') }}" class="btn-empty">
                        <i class="bi bi-plus-circle-fill"></i>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <p class="modal-text">Apakah Anda yakin ingin menghapus ras hewan <strong id="deleteItemName"></strong>?</p>
    ...
    <script>
        ...
        function searchTable() {
            ...
            filteredRows = allRows.filter(row => {
                const tdRas = row.getElementsByTagName('td')[1]; // Kolom nama ras
                const tdJenis = row.getElementsByTagName('td')[2]; // Kolom jenis hewan
                
                let isMatch = false;
                
                if (tdRas) {
                    const txtRas = tdRas.textContent || tdRas.innerText;
                    isMatch = txtRas.toLowerCase().includes(filter);
                }
                
                if (!isMatch && tdJenis) {
                    const txtJenis = tdJenis.textContent || tdJenis.innerText;
                    isMatch = txtJenis.toLowerCase().includes(filter);
                }
