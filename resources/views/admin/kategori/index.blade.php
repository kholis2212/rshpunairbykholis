{{-- views/admin/kategori/index.blade.php --}}
@extends('layouts.lte.main')

@section('title', 'Data Kategori - RSHP UNAIR')

@section('page-icon', 'folder-fill')
...
@section('content')
    ...
    <div class="info-banner mb-4">
        ...
        <div class="info-banner-content">
            <h6>Tentang Data Kategori</h6>
            <p>Kelola kategori layanan dan tindakan medis seperti vaksinasi, bedah, diagnostik, dan lainnya untuk sistem RSHP UNAIR</p>
        </div>
    </div>
        ...
        <div class="card-header">
            <div class="card-header-left">
                ...
                <div class="header-text">
                    ...
                    <p>Total: <span class="badge badge-count">{{ $kategori->count() }}</span> kategori terdaftar</p>
                </div>
            </div>
        </div>
        ...
        <div class="card-body p-0">
            @if($kategori->count() > 0)
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        <button data-id="{{ $item->idkategori }}" 
                ...
                <div class="table-footer">
                    <div class="showing-entries">
                        ...
                        <span id="showingText">Menampilkan 1 hingga {{ min(10, $kategori->count()) }} dari {{ $kategori->count() }} data</span>
                    </div>
            ...
            @else
                <div class="empty-state">
                    ...
                    <p>Silakan tambahkan data kategori terlebih dahulu untuk memulai</p>
                    <a href="{{ route('admin.kategori.create') }}" class="btn-empty">
                        <i class="bi bi-plus-circle-fill"></i>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <p class="modal-text">Apakah Anda yakin ingin menghapus kategori <strong id="deleteItemName"></strong>?</p>
    ...
    <script>
        ...
        function searchTable() {
            ...
            filteredRows = allRows.filter(row => {
                const td = row.getElementsByTagName('td')[1]; // Kolom nama kategori
                if (td) {
