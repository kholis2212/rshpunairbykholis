...
<head>
    ...
    <title>Data Kategori - RSHP UNAIR</title>
    ...
    <div class="container">
        <div class="header-card">
            <div class="header-title">
                ...
                <div>
                    <h1>Data Kategori</h1>
                    <p>Kelola kategori layanan dan tindakan medis</p>
                </div>
            </div>
            ...
            <div class="table-wrapper">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-buttons" style="justify-content: center;">
                                        ...
                                        <button onclick="confirmDelete({{ $item->idkategori }}, '{{ $item->nama_kategori }}')" class="btn btn-danger btn-sm">
                                            <span>🗑️</span>
                                            <span>Hapus</span>
                                        </button>
                                    </div>
                ...
                @else
                    <div class="empty-state">
                        ...
                        <p>Silakan tambahkan data kategori terlebih dahulu</p>
                        <a href="{{ route('admin.kategori.create') }}" class="btn btn-success" style="margin-top: 20px;">
                            <span>➕</span>
