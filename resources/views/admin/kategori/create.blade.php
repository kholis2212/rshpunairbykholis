{{-- views/admin/kategori/create.blade.php --}}
        ...
        <div class="col-lg-8 col-md-10">
            ...
            <div class="info-card mb-4">
                ...
                <div class="info-card-content">
                    <h6>Informasi</h6>
                    <p>Pastikan nama kategori yang Anda masukkan belum terdaftar dalam sistem untuk menghindari duplikasi data</p>
                </div>
            </div>
                    ...
                    <form action="{{ route('admin.kategori.store') }}" method="POST" id="formCreate">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-hint">
                                ...
                                <span>Masukkan nama kategori yang spesifik dan mudah dikenali</span>
                            </div>
                        </div>
