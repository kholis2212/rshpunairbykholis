    ...
    <div class="container">
        <div class="form-card">
            <div class="form-header">
                ...
                <h1>Edit Kategori</h1>
                <p>Perbarui data kategori yang sudah ada</p>
            </div>

            <div class="form-body">
                <div class="current-value">
                    <div class="current-value-label">📝 Nilai Saat Ini:</div>
                    <div class="current-value-text">{{ $kategori->nama_kategori }}</div>
                </div>

                <div class="form-hint">
                    <span>Pastikan nama kategori yang baru tidak duplikat dengan data yang sudah ada</span>
                </div>
