{{-- views/admin/kategori/edit.blade.php --}}
        ...
        <div class="col-lg-8 col-md-10">
            ...
            <div class="warning-card mb-4">
                ...
                <div class="warning-card-content">
                    <h6>Perhatian!</h6>
                    <p>Pastikan nama kategori yang baru tidak duplikat dengan data yang sudah ada untuk menghindari konflik data dalam sistem</p>
                </div>
            </div>
            ...
            <div class="card form-card">
                <div class="card-header">
                    ...
                    <div class="card-header-text">
                        ...
                        <p>Perbarui data kategori dengan informasi yang benar</p>
                    </div>
                </div>
                    ...
                    <form action="{{ route('admin.kategori.update', $kategori->idkategori) }}" method="POST" id="formEdit">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-hint">
                                ...
                                <span>Ubah nama kategori sesuai dengan kebutuhan sistem</span>
                            </div>
                        </div>
                        ...
                        <div class="comparison-section">
                            ...
                            <div class="comparison-grid">
                                <div class="comparison-item comparison-old">
                                    ...
                                    <div class="comparison-value">{{ $kategori->nama_kategori }}</div>
                                </div>
                                ...
                                <div class="comparison-item comparison-new">
                                    ...
                                    <div class="comparison-value" id="newValuePreview">
                                        {{ old('nama_kategori', $kategori->nama_kategori) }}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-actions">
                            ...
                            <a href="{{ route('admin.kategori.index') }}" class="btn btn-secondary btn-cancel">
...
@section('extra-js')
    <script>
        ...
        input.addEventListener('input', function() {
            const newValue = this.value.trim() || '{{ $kategori->nama_kategori }}';
        ...
        document.getElementById('formEdit').addEventListener('submit', function(e) {
            if (input.value.trim() === '') {
                ...
                if (!document.querySelector('.invalid-feedback')) {
                    ...
                    errorDiv.innerHTML = '<i class="bi bi-exclamation-circle-fill"></i><span>Nama kategori wajib diisi!</span>';
