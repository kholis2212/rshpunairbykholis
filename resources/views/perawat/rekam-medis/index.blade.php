...
@section('content')
    ...
    <div class="info-banner mb-4">
        ...
        <div class="info-banner-content">
            ...
            <p>Kelola seluruh data rekam medis pasien. Anda dapat menambah, mengedit, melihat detail, dan menghapus rekam medis</p>
        </div>
    </div>
        ...
        <div class="card-body p-0">
                ...
                <div class="table-controls">
                    <div class="controls-left">
                        ...
                        <div class="search-box">
                            ...
                            <input type="text" id="searchInput" placeholder="Cari nama hewan atau pemilik">
                        </div>
                    </div>
                    
                    <div class="controls-right">
                        <!-- Tombol Tambah Rekam Medis dipindahkan ke sini -->
                        <a href="{{ route('perawat.rekam-medis.create') }}" class="btn-add">
                            <i class="bi bi-plus-circle-fill"></i>
                            <span class="btn-text">Tambah Rekam Medis</span>
                        </a>
                    </div>
                </div>
                            ...
                            <tr data-jenis="{{ $rekam->pet->rasHewan->jenisHewan->nama_jenis_hewan }}">
                                ...
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        <a href="{{ route('perawat.rekam-medis.edit', $rekam->idrekam_medis) }}" 
                                        ...
                                        <button data-id="{{ $rekam->idrekam_medis }}" 
                                                data-name="{{ $rekam->pet->nama }}"
            ...
            @else
                <div class="empty-state">
                    ...
                    <p>Silakan tambahkan rekam medis terlebih dahulu untuk memulai</p>
                    <a href="{{ route('perawat.rekam-medis.create') }}" class="btn-empty">
                        <i class="bi bi-plus-circle-fill"></i>
                        <span>Tambah Rekam Medis Pertama</span>
                    </a>
                </div>
            @endif
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <p class="modal-text">Apakah Anda yakin ingin menghapus rekam medis untuk <strong id="deleteItemName"></strong>?</p>
...
@section('extra-js')
    <script>
        ...
        function confirmDelete(id, name) {
            ...
            form.action = `/perawat/rekam-medis/${id}`;
