...
@section('title', 'Profile Perawat - RSHP UNAIR')

@section('page-icon', 'person-badge-fill')
@section('page-title', 'Profile Perawat')
        ...
        <div class="col-lg-10">
            ...
            <div class="profile-header-card mb-4">
                ...
                <div class="profile-info">
                    <h1>{{ $user->nama }}</h1>
                    <p class="profile-role">Perawat</p>
                    <div class="profile-stats">
                        ...
                        <div class="stat-item">
                            ...
                            <span>{{ $perawat->no_hp ?? 'Belum diatur' }}</span>
                        </div>
                        <div class="stat-item">
            ...
            <div class="card profile-form-card">
                ...
                <div class="card-body">
                    <form action="{{ route('perawat.profile.update') }}" method="POST" id="profileForm">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-wrapper">
                                        <select id="pendidikan" 
                                            ...
                                            <option value="D3 Keperawatan" {{ old('pendidikan', $perawat->pendidikan ?? '') == 'D3 Keperawatan' ? 'selected' : '' }}>D3 Keperawatan</option>
                                            <option value="D4 Keperawatan" {{ old('pendidikan', $perawat->pendidikan ?? '') == 'D4 Keperawatan' ? 'selected' : '' }}>D4 Keperawatan</option>
                                            <option value="S1 Keperawatan" {{ old('pendidikan', $perawat->pendidikan ?? '') == 'S1 Keperawatan' ? 'selected' : '' }}>S1 Keperawatan</option>
                                            <option value="S2 Keperawatan" {{ old('pendidikan', $perawat->pendidikan ?? '') == 'S2 Keperawatan' ? 'selected' : '' }}>S2 Keperawatan</option>
                                            <option value="S3 Keperawatan" {{ old('pendidikan', $perawat->pendidikan ?? '') == 'S3 Keperawatan' ? 'selected' : '' }}>S3 Keperawatan</option>
                                            <option value="Sp.Kep" {{ old('pendidikan', $perawat->pendidikan ?? '') == 'Sp.Kep' ? 'selected' : '' }}>Spesialis Keperawatan (Sp.Kep)</option>
                                        </select>
                                        <div class="input-icon">
