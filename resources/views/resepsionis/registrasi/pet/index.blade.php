...
@section('page-title', 'Registrasi Hewan Peliharaan')

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('resepsionis.dashboard-resepsionis') }}">Dashboard</a></li>

    <li class="breadcrumb-item active">Registrasi Hewan</li>
@endsection
...
@section('content')
    ...
    <div class="info-banner mb-4">
        ...
        <div class="info-banner-content">
            <h6>Tentang Data Hewan</h6>
            <p>Kelola data hewan peliharaan yang terdaftar di RSHP UNAIR. Pastikan data jenis, ras, dan pemilik selalu sesuai</p>
        </div>
    </div>
        ...
        <div class="card-body p-0">
                ...
                <div class="table-controls">
                    <div class="controls-left">
                        ...
                        <div class="search-box">
                            ...
                            <input type="text" id="searchInput" placeholder="Cari nama hewan, pemilik, atau jenis...">
                        </div>
                    </div>
                    
                    <!-- Tombol Hewan dipindahkan ke sini -->
                    <div class="controls-right">
                        <a href="{{ route('resepsionis.registrasi.pet.create') }}" class="btn-add">
                            <i class="bi bi-paw-fill"></i>
                            <span class="btn-text">Registrasi Hewan Baru</span>
                        </a>
                    </div>
                </div>
                ...
                <div class="table-responsive" id="tableView">
                    <table class="table data-table" id="dataTable">
                        ...
                        <tbody id="tableBody">
                            ...
                            <tr data-jenis="{{ $pet->rasHewan->jenisHewan->nama_jenis_hewan }}">
                                <td>
                                ...
                                <td>
                                    <div class="table-main-info">
                                        <div class="pet-avatar">
                                            @if(str_contains($pet->rasHewan->jenisHewan->nama_jenis_hewan, 'Anjing'))
                                                🐕
                                            @elseif(str_contains($pet->rasHewan->jenisHewan->nama_jenis_hewan, 'Kucing'))
                                                🐈
                                            @elseif(str_contains($pet->rasHewan->jenisHewan->nama_jenis_hewan, 'Burung'))
                                                🐦
                                            @elseif(str_contains($pet->rasHewan->jenisHewan->nama_jenis_hewan, 'Kelinci'))
                                                🐇
                                            @else
                                                🐾
                                            @endif
                                        ...
                                        <div class="pet-info">
                                            ...
                                            <small>{{ $pet->warna_tanda }}</small>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="breed-info">
                                        <span class="breed-type">{{ $pet->rasHewan->jenisHewan->nama_jenis_hewan }}</span>
                                        <span class="breed-name">{{ $pet->rasHewan->nama_ras }}</span>
                                    </div>
                                </td>
                                <td>
                                    <div class="owner-info">
                                        <strong>{{ $pet->pemilik->user->nama }}</strong>
                                        <small>{{ $pet->pemilik->no_wa }}</small>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="date-info">
                                        @if($pet->tanggal_lahir)
                                            <strong>{{ \Carbon\Carbon::parse($pet->tanggal_lahir)->format('d M Y') }}</strong>
                                            <small>Usia: {{ \Carbon\Carbon::parse($pet->tanggal_lahir)->age }} tahun</small>
                                        @else
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <a href="{{ route('resepsionis.registrasi.pet.edit', $pet->idpet) }}" 
            ...
            @else
                <div class="empty-state">
                    ...
                    <p>Silakan tambahkan data hewan terlebih dahulu untuk memulai</p>
                    <a href="{{ route('resepsionis.registrasi.pet.create') }}" class="btn-empty">
                        <i class="bi bi-plus-circle-fill"></i>
                        <span>Tambah Hewan Pertama</span>
                    </a>
                </div>
            @endif
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <p class="modal-text">Apakah Anda yakin ingin menghapus data hewan <strong id="deleteItemName"></strong>?</p>
    ...
    <style>
        ...
        .breed-info, .owner-info, .date-info {
            display: flex;
            flex-direction: column;
        }

        .breed-type, .owner-info strong, .date-info strong {
            font-weight: 600;
            color: var(--text-dark);
            font-size: 0.9rem;
        }

        .breed-name, .owner-info small, .date-info small {
            font-size: 0.8rem;
            color: var(--text-gray);
        }
...
@section('extra-js')
    <script>
        ...
        function searchTable() {
            ...
            // Add sorting by pet name
            filteredRows.sort((a, b) => {
                const namaA = a.cells[1].textContent.toLowerCase();
                const namaB = b.cells[1].textContent.toLowerCase();
        ...
        function confirmDelete(id, name) {
            ...
            form.action = `/resepsionis/registrasi/pet/${id}`;
